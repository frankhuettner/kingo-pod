...
CloudBeaver walkthrough, a table of contents per page and a Copy button on every
command.
...
title, one-line summary and menu label (kept out of the markdown, where front
matter would show up as a stray table in the GitHub view).
