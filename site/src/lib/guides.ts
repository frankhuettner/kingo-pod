...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    summary: "Same result as the Mac guide, but the 13 GB of images come off the instructor's stick.",
    nav: "Mac · USB",
    platform: "Mac",
    kind: "USB stick",
  },
  {
    ...
    summary: "Same result as the Windows guide, but the 13 GB of images come off the instructor's stick.",
    nav: "Windows · USB",
    platform: "Windows",
    kind: "USB stick",
  },
